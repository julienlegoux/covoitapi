...
import { listUserInscriptions, listTripPassengers } from '../../controllers/inscription.controller.js';
...
v1Routes.get('/trips/:id/passengers', authMiddleware, requireRole('USER'), listTripPassengers);
